use crate::clocks::SystemTimeSpec;
...
pub trait WasiFile: Send + Sync {
    ...
    fn sock_accept(&mut self, _fdflags: FdFlags) -> Result<Box<dyn WasiFile>, Error> {
        Err(Error::badf())
    }
    ...
    fn sock_shutdown(&mut self, _how: SdFlags) -> Result<(), Error> {
        Err(Error::badf())
    }
    ...
    fn set_fdflags(&mut self, _flags: FdFlags) -> Result<(), Error> {
        Err(Error::badf())
    }
    ...
    fn set_filestat_size(&mut self, _size: u64) -> Result<(), Error> {
        Err(Error::badf())
    }

    fn advise(&mut self, _offset: u64, _len: u64, _advice: Advice) -> Result<(), Error> {
        Err(Error::badf())
    }

    fn allocate(&mut self, _offset: u64, _len: u64) -> Result<(), Error> {
        Err(Error::badf())
    }
    ...
    fn read_vectored<'a>(&mut self, _bufs: &mut [std::io::IoSliceMut<'a>]) -> Result<u64, Error> {
        Err(Error::badf())
    }
...
impl FileEntry {
    ...
    pub fn get_fdstat(&mut self) -> Result<FdStat, Error> {
        Ok(FdStat {
